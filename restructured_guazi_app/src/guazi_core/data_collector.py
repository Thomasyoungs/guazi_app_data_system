"""Data collection for the Guazi app data system.

Provides data collection, target car simulation, and reference car generation
migrated from the original system.
"""
...
class DataCollector:
    ...
    def collect_whitelisted_from_text(self, state_id: str, text: str) -> dict[str, Any]:
        """Extract whitelisted fields from UI text."""
        data: dict[str, Any] = {}
